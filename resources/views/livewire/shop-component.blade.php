        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="wrap-shop-control">
                    ...
                    <h1 class="shop-title">LITTLE SHOP OF HORROS</h1>
                    ...
                    <div class="wrap-right">
                        ...
                        <div class="sort-item orderby ">
                            <select name="orderby" class="use-chosen" wire:model="sorting">
                                ...
                                <option value="date">Más nuevo</option>
                        ...
                        <div class="sort-item product-per-page">
                            <select name="post-per-page" class="use-chosen" wire:model="pagesize">
                                <option value="6" selected="selected">6 por página</option>
            ...
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
                ...
                <div class="widget mercado-widget filter-widget price-filter">
                    <h2 class="widget-title">Precio <span class='text-info'>{{ $min_price }} - {{ $max_price }}</span></h2>
                    <div class="widget-content">
